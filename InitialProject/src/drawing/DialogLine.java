...
public class DialogLine extends JDialog {
	...
	public DialogLine(DrawingFrame frame, Line selectedShape, Point firstPoint, Point secondPoint) {
		...
		{
			colorButton = new JButton("Outer Color");
			colorButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					outerColor = JColorChooser.showDialog(null, "Choose Color", Color.BLACK);
		...
		if(selectedShape == null) {
			...
			x1Txt.setText(Integer.toString(selectedShape.getStartPoint().getX()));
			y1Txt.setText(Integer.toString(selectedShape.getStartPoint().getY()));
			
			x2Txt.setText(Integer.toString(selectedShape.getEndPoint().getX()));
