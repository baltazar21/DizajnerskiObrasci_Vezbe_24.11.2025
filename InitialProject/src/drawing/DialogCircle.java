...
public class DialogCircle extends JDialog {
    ...
    public DialogCircle(DrawingFrame frame, Circle selectedShape) {
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				  try {
				        ...
				        if (selectedShape == null)
				            System.out.println("Finished Draw DialogCircle Radius: " + r);
				        else
				            System.out.println("Finished Modify Circle");
        ...
        if(selectedShape == null) {
        	...
        	this.setTitle("Circle - Draw Mode");
        }else {
        	...
        	xTxt.setText(String.valueOf(selectedShape.getCenter().getX()));
        	yTxt.setText(String.valueOf(selectedShape.getCenter().getY()));
        	radiusTxt.setText(String.valueOf(selectedShape.getRadius()));
        	...
        	this.setTitle("Circle - Modify Mode");
        }
    }
